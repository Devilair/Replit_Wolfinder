...
- June 17, 2025. FAKE DATA PURGE COMPLETATA: Eliminazione sistematica di tutti i dati inventati dalla dashboard admin. Risolto errore critico "is_moderated" nel sistema recensioni rimuovendo campo obsoleto dal schema. Dashboard ora mostra dati 100% reali: 43 utenti, 6 professionisti (1 verificato), 0 recensioni, €0 revenue. Sistema pronto per decisioni business accurate basate su dati autentici
